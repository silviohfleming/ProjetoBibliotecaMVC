...
using ProjetoBibliotecaMVC.Utils;
using Microsoft.AspNetCore.Http;
using System.IO;
using Microsoft.AspNetCore.Hosting;

namespace ProjetoBibliotecaMVC.Controllers
{
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var livro = await _context.Livro.AsNoTracking().Include(l => l.LivroAutor).ThenInclude(li => li.Autor).SingleOrDefaultAsync(m => m.LivroID == id);
